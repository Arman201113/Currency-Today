...
class Convert: UIViewController {
    ...
    func configure(){
        ...
        models.append(contentsOf: [
            ...
            ConvertOption(name: "RUB", BgI: UIImage(named: "Russia")!, BgC: .systemTeal, api: "https://open.er-api.com/v6/latest/RUS"),
            ...
            ConvertOption(name: "GEL", BgI: UIImage(named: "Georgia")!, BgC: .systemTeal, api: "https://open.er-api.com/v6/latest/DEL"),
            ...
            ConvertOption(name: "INR", BgI: UIImage(named: "India")!, BgC: .systemTeal, api: "https://open.er-api.com/v6/latest/BGI"),
